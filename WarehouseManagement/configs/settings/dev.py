...
DATABASES = {
    'default': {
        ...
        'NAME': 'SlaughterERP_WarehouseManagement',
        'USER': 'postgres',
...
# mongoDB settings
MONGODB_SETTINGS = {
    "db": "SlaughterERP_WarehouseManagement",
    "host": "mongodb://localhost:27017/SlaughterERP_WarehouseManagement",
}
...
MICROSERVICE_CONFIGS = {
    ...
    'SlaughterERP': {
        'username': 'service_warehouse_management',
        'password': '12345'
    }
}
