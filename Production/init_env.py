#!/usr/bin/env python3
# init_env.py - interactive .env creator for SlaughterERP_Production
...
env_path = Path(".env")
print("=== init_env: Create / update .env file for SlaughterERP_Production project ===")
...
POSTGRES_DB = input_with_default("POSTGRES_DB", "SlaughterERP_Production")
...
MONGODB_URI = input_with_default("MONGODB_URI", "mongodb://localhost:27017/SlaughterERP_Production")
MONGODB_DB = input_with_default("MONGODB_DB", "SlaughterERP_Production")
...
MS_SLAUGHTERERP_USERNAME = input_with_default("MS_SLAUGHTERERP_USERNAME", "service_production")
