...
from api.v1.production.production_series.swagger_documentation import FinishStartActionSerializer
...
@method_decorator(name='bulk_patch_request', decorator=custom_swagger_generator(serializer_class=ProductionSeriesSerializerPOST, method='bulk_patch', many=True))
@method_decorator(name='single_patch_request', decorator=custom_swagger_generator(serializer_class=ProductionSeriesSerializerPOST, method='single_patch', many=False))
@method_decorator(name='bulk_get', decorator=custom_swagger_generator(serializer_class=ProductionSeriesSerializerPOST, method='bulk_get', many=True))
@method_decorator(name='single_get', decorator=custom_swagger_generator(serializer_class=ProductionSeriesSerializerPOST, method='single_get', many=False))
@method_decorator(name='bulk_delete_request', decorator=custom_swagger_generator(serializer_class=ProductionSeriesSerializerPOST, method='bulk_delete', many=True))
@method_decorator(name='single_delete_request', decorator=custom_swagger_generator(serializer_class=ProductionSeriesSerializerPOST, method='single_delete', many=False))
